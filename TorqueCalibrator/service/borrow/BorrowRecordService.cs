...
namespace TorqueCalibrator.service.borrow
{
    interface BorrowRecordService
    {
        List<BorrowRecord> selectListByAll(string id, string seriesNum, string operatorName, DateTime startTime, DateTime endTime, int status = -1);
