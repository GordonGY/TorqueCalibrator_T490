...
{
    public static class MESMysqlTool
    {
        private static readonly string StrCon = ConfigurationManager.ConnectionStrings["MESMysqlConnection"].ToString();
        //废弃代码
        #region
        ...
        public static List<T> toList<T>(this DataTable dt) where T : class, new()
        {
            ...
            Array.ForEach<PropertyInfo>(t.GetProperties(), p => { if (dt.Columns.IndexOf(p.Name.ToUpper()) != -1) prlist.Add(p); });
